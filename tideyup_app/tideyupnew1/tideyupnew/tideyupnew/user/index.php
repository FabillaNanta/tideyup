...
<style>
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="col d-flex align-items-start">
        ...
        <div class="text-dark font-monospace">
          <h2>tidepad</h2>
          <p class="text-dark">Record or take personal notes primarly for your oceans wave observation data. Simply fill in the form then you can review your structured notes!</p>
  ...
  <div class="card-body">
    ...
    <p class="card-text">come back soon!<br><br>
    <a href="logout.php" class="btn btn-warning">logout</a>
  </div>
  <div class="card-footer text-white font-monospace">
    courtesy of Fabilla Nanta (2010030) and Ita Arianti (2007987)
  </div>
</div>
