...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2021 at 04:19 AM
...
--
ALTER TABLE `tidepad`
  MODIFY `id_data` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9003;

--
-- AUTO_INCREMENT for table `user_login`
--
ALTER TABLE `user_login`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=465;
COMMIT;
